    ...
    <section className="container mx-auto p-6">
      <div className="w-full mb-8 overflow-hidden rounded-lg shadow-lg">
        <div className="p-6 w-full flex items-center justify-around bg-green-300">
          ...
          <button onClick={()=>{navigate('/new_module')}} className={`${authState.user.role.toLowerCase() === "Student".toLowerCase() ? "hidden" : "flex gap-2 items-center px-2 py-1 bg-blue-700 rounded shadow text-white"} `}>
